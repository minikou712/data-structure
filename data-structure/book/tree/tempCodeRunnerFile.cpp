...
int main()
{
    ...
    root3->right = createNode("e");
    root3->left->left = createNode("-");
    root3->left->right = createNode("+");
    root3->left->left->left = createNode("a");
    root3->left->left->right = createNode("b");
    root3->left->right->left = createNode("c");
    root3->left->right->right = createNode("d");
